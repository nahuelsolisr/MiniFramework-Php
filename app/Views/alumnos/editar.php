    ...
    <form action="/alumnos/update" method="post">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="apellido" name="apellido" required value="<?= $alumno['apellido'] ?>">
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="documento" name="documento" required value="<?= $alumno['documento'] ?>">
            </div>
            <div class="col-md-6 mb-3">
                <!-- Campo para la fecha de nacimiento del alumno -->
                <!-- Se utiliza el atributo 'required' para hacer que el campo sea obligatorio -->
                <label for="fecha_nacimiento" class="form-label">Fecha de Nacimiento</label>
                <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" required value="<?= $alumno['fecha_nacimiento'] ?>">
            </div>
        </div>
